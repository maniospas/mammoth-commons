...
def test_kfp_pipeline():
    ...
    def pipeline(model_onnx__params: Dict, data_auto_csv__params: Dict, sensitive: List, model_card__params: Dict):
    ...
    pipeline(
        model_onnx__params={"path": "https://github.com/mammoth-eu/mammoth-commons/raw/refs/heads/dev/data/model.onnx"},
